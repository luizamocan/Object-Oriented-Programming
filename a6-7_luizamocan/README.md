...
6. Create a UML class diagram for your entire application. For this, you can use any tool that you like ([StarUML](https://staruml.io/), [LucidChart](https://www.lucidchart.com/ or [draw.io](https://app.diagrams.net/)) are only some examples. Many other options exist.
